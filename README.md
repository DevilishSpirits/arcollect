...
I recommend you to grab a prebuilt package from the [latest release](https://github.com/DevilishSpirits/arcollect/releases/tag/v0.23) and to checkout his [README.md](https://github.com/DevilishSpirits/arcollect/tree/v0.23#readme). You must install/upgrade the webextension in your web-browser to use Arcollect.
