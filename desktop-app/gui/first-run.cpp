...
void Arcollect::gui::first_run::render(SDL::Rect target)
{
	...
	if ((cache_window_width != target.w)||!render_cache) {
		render_cache = std::make_unique<Arcollect::gui::font::Renderable>(Arcollect::gui::font::Elements::build(Arcollect::gui::font::FontSize(1.5),U"This is your first Arcollect run !\n\n"
		...
		"Now press and release the right arrow to see what's next…"sv),target.w-target.w/10);
