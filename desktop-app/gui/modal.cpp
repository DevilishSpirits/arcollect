...
void Arcollect::gui::modal::render_titlebar(SDL::Rect target, int window_width)
{
	...
	if (!cached_render) {
		static const auto text = Arcollect::gui::font::Elements::build(U"Arcollect "sv ARCOLLECT_VERSION_STR,Arcollect::gui::font::ExactFontSize(target.h-2*title_border));
