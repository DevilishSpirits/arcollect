...
Arcollect::gui::rating_selector_menu::rating_selector_menu(void) : rating_selector_menu(Arcollect::set_filter_rating,font::Elements::build(i18n_desktop_app.rating_selector_label)) {}
