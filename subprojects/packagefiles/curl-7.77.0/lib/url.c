 ...
 */
static const struct Curl_handler * const url_c_protocols[] = {
...
const struct Curl_handler *Curl_builtin_scheme(const char *scheme)
{
  ...
  for(pp = url_c_protocols; (p = *pp) != NULL; pp++)
